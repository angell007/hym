(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('lodash.clonedeep')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/forms', 'lodash.clonedeep'], factory) :
	(factory((global['ng-selectize'] = global['ng-selectize'] || {}),global.ng.core,global.ng.forms,global.cloneDeep));
}(this, (function (exports,_angular_core,_angular_forms,cloneDeep) { 'use strict';
...
NgSelectizeComponent.propDecorators = {
    ...
    'hasOptionsPlaceholder': [{ type: _angular_core.Input },],
    'noOptionsPlaceholder': [{ type: _angular_core.Input },],
    'enabled': [{ type: _angular_core.Input },],
    ...
    'optgroups': [{ type: _angular_core.Input },],
};
