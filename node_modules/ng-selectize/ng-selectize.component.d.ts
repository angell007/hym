import { OnInit, OnChanges, SimpleChanges, DoCheck, Renderer2, EventEmitter, IterableDiffers } from '@angular/core';
import { ControlValueAccessor, FormControl } from '@angular/forms';
export declare const SELECTIZE_VALUE_ACCESSOR: any;
export declare class NgSelectizeComponent implements OnInit, OnChanges, DoCheck, ControlValueAccessor {
    private _differs;
    private renderer;
    config: any;
    private _options;
