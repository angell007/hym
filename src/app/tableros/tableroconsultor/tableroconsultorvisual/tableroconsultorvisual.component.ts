...
@Component({
  selector: 'app-tableroconsultorvisual',
  templateUrl: './tableroconsultorvisual.component.html',
  styleUrls: ['./tableroconsultorvisual.component.scss'],
})

export class TableroconsultorvisualComponent implements OnInit, OnDestroy {
