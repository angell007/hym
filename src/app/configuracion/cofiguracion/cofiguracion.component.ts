...
export class CofiguracionComponent implements OnInit, AfterViewInit {
  ...
  /*ngAfterViewInit() {
    ...
    this.http.get(this.ruta+'php/configuracion/lista_monedas.php',{ params: { modulo: 'Moneda'}}).subscribe((data:any)=>{
      let consulta= data;   
      for(var i=0; i < consulta.length; ++i)
      {
        this.http.get(this.ruta+'php/configuracion/configuracion_detalle.php',{
