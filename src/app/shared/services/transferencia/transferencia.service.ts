...
export class TransferenciaService {
  ...
  getRecibosTransferenciasFuncionario(idFuncionario: string): Observable<any> {
    ...
    return this.client.post(this.globales.rutaNueva + 'get_recaudos_funcionario', p);
  }

  getRecaudosFuncionario(idFuncionario: string): Observable<any> {
    let p = { id_funcionario: idFuncionario };
    return this.client.post(this.globales.rutaNueva + 'get_recaudos_funcionario', p);
  }

  getRecaudosFuncionario2(p: any): Observable<any> {
    return this.client.post(this.globales.rutaNueva + 'get_recaudos_funcionario', p);
  }
