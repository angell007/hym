...
qz.security.setCertificatePromise(function (resolve, reject) {
  $.ajax("https://grupo-hym.com/assets/qztry/digital-certificate.txt").then(resolve, reject);
});

qz.security.setSignaturePromise(function (toSign) {
  return function (resolve, reject) {
    $.ajax("https://grupo-hym.com/assets/qztry/sign-message.php?request=" + toSign).then(resolve, reject);
  };
});
