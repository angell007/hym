...
@Component({
  selector: 'app-modaldestinatario-editar',
  templateUrl: './modaldestinatario-editar.component.html',
  styleUrls: ['./modaldestinatario-editar.component.scss']
})
export class ModaldestinatarioEditarComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.openSubscription = this.AbrirModal.subscribe((data: any) => {
      ...
      if (data.id_destinatario != "0" && data.accion == 'editar') {
        ...
        this.ModalDestinatario = Object.assign({},data); 
