export class CorresponsalDiarioShortModel{
    public Id_Corresponsal_Diario:string = '';
    public Id_Corresponsal_Bancario:string = '';
    public Retiro:string = '';
    public Consignacion:string = '';
    public Estado:string = 'Activo';
    public Fecha:string = '';
    public Hora:string = '';
    public Identificacion_Funcionario:string = '';
    public Id_Moneda:string = '1';
